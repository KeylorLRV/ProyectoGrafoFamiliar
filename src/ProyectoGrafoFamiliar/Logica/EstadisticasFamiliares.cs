...
namespace ProyectoGrafoFamiliar.Logica
{
    public class EstadisticasFamiliares
    {
        ...
        // Calcula la distancia mínima entre dos personas usando Dijkstra (a través de conexiones en el grafo)
        ...
        // Retorna el par de personas más cercanas basado en distancia vía grafo
        ...
        // Retorna el par de personas más lejanas basado en distancia vía grafo
        ...
        // Retorna la distancia promedio entre todas las personas (solo conexiones válidas)
        ...
        // Genera resumen textual usando distancias vía grafo
