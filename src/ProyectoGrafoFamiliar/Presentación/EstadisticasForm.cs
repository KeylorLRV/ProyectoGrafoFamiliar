...
namespace ProyectoGrafoFamiliar.Presentacion
{
    public partial class EstadisticasForm : Form
    {
        ...
        private void MostrarEstadisticas()
        {
            ...
            // Función que crea una tarjeta (igual que antes)
            Panel CrearTarjeta(Persona persona, Persona otraPersona)
            {
                ...
                // Label para la distancia al otro miembro del par (usando CalculadoraDistancia a través de estadisticas)
            ...
            // Función que crea una sección con título y tarjetas horizontales
